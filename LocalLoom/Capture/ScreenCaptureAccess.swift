...
/// LocalLoom re-prompt each time "Recordings…" was opened.
///
...
enum ScreenCaptureAccess {
    ...
    static let staleGrantHint =
        "If LocalLoom is already enabled in System Settings, quit the app fully from the menu bar and reopen so macOS can apply the grant to this build."
}
