...
struct MenuBarStatusLabel: View {
    ...
    private var helpText: String {
        switch engine.phase {
        case .idle: return "Specreel — Idle"
        case .recording: return "Specreel — Recording (click to stop)"
        case .paused: return "Specreel — Paused (click to stop)"
        }
    }
}
...
struct MenuBarPopover: View {
    ...
    private var header: some View {
        HStack {
            Text(engine.phase == .idle ? "New Recording" : "Specreel")
                .font(.headline)
            Spacer()
            phaseBadge
        }
    ...
    private var phaseBadge: some View {
        ...
        case .recording:
            Text(MenuBarStatusLabel.elapsedString(engine.elapsed))
                ...
                .foregroundStyle(SpecreelTheme.record)
        case .paused:
